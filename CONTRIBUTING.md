...
For new behavior, API contracts, validation rules, safety boundaries, or provider behavior, use **Red → Green → Refactor**:
...
For security-sensitive or mutating behavior, cover both allowed and rejected cases.
